  ...
  return (
    <motion.div variants={containerVariants} initial="hidden" whileInView="visible" viewport={{ once: false, amount: 0.2 }} className="w-full lg:w-[60%] text-left">
      ...
      <motion.div variants={itemVariants} className="space-y-3 font-body text-description-text text-base md:text-lg leading-relaxed text-center lg:text-left">
        ...
        <p>I bring clarity to complex ideas by taking full ownership—from problem research and UI design to frontend implementation and team alignment.</p>
        ...
        <ExpandableText
          ...
          text={
            <div className="space-y-3">
              <p>
                I don’t just write code; I approach product development by defining core user problems first. This led me to initiate and lead <span className="font-semibold text-white">TreeHealthy</span>, driving its design & frontend
                architecture to achieve the <span className="font-semibold text-accent">Best Capstone Project at Dicoding Bootcamp</span>.
              </p>
              <p>
                Beyond bootcamps, I’ve led a <span className="font-semibold text-white">TreeX</span> team to become a <span className="font-semibold text-accent">Top 10 Finalist in the Healtech UI/UX Challenge 2025</span> and delivered
                real-world client solutions.
              </p>
              <p>Currently focusing on my React execution with strong software engineering practices.</p>
            </div>
          }
        />
      </motion.div>
