...
export const certificates: PortfolioItem[] = [
  {
    id: 201,
    title: "Best Capstone Project - TreeHealthy (Dicoding Bootcamp Batch 13)",
    description:
      "Awarded Best Capstone Project for developing 'TreeHealthy' with team DB13-G002. Led the frontend architecture and implementation, delivering a seamless user experience, solid component structure, and responsive design within an intensive bootcamp environment.",
    coverImage: "/cover/certificates/dicoding-bootcamp.png",
    tags: ["React", "Frontend Engineering", "Team Leadership", "Problem Solving", "Capstone Project", "UI/UX Translation"],
    type: "certificate",
    publisher: "Dicoding Indonesia",
    issuedDate: "21 Aug 2026",
    credentialSrc: ["/docs/certs/best-capstone.jpg"],
  },

  {
    ...
    type: "certificate",
    publisher: "ITSK RS dr. Soepraoen",
    issuedDate: "17 Oct 2025",
