...
export const BasicCard = ({ id, title, description, coverImage, tags, link, type, isSelected, initialReactions }: BasicCardProps) => {
  ...
  "
      >
        <ProjectReaction projectId={String(id)} initialReactions={initialReactions} />
      </div>
    </div>
  );
};
